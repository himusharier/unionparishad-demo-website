...
if (isset($_POST['linkedForm']) && isset($_POST['renewHoldingID'])) {
    $_SESSION['linkedForm'] = $_POST['linkedForm'];
    $_SESSION['renewHoldingID'] = $_POST['renewHoldingID'];
}

if (!empty($_SESSION['linkedForm']) && !empty($_SESSION['renewHoldingID'])) {
    $linkedForm = $_SESSION['linkedForm'];
    $renewHoldingID = $_SESSION['renewHoldingID'];
} else {
    echo "<script type='text/javascript'> document.location = 'citizen/holding-tax'; </script>";
    die();
}
...
if($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (isset($_POST['payment-done'])) {
        ...
        $paymentUpdate = "UPDATE renew_house_holding_database SET paymentStatus='Paid' WHERE (linkedForm='$linkedForm' AND renewHoldingID='$renewHoldingID')";
...
<script>
    ...
    function getPDF(){
        ...
        html2canvas($("#print-main-div-holding")[0],{allowTaint:true}).then(function(canvas) {
            ...
            pdf.save("<?php echo "payment-$renewHoldingID" ?>.pdf");
...
<div class="content-body-main-div">
    ...
    <p class="page-direction"><i class="fa fa-link"></i> নাগরিক পোর্টাল / হোল্ডিং ট্যাক্স / বিস্তারিত /</p>

    <div class="admin-dashboard-content-div">

        <h2 style="font-family:'Bangla';color: #5e5e5e;border-bottom:1px solid #5e5e5e;">হোল্ডিং ট্যাক্স বিস্তারিতঃ</h2>
        <?php
        $sqlr = "SELECT * FROM renew_house_holding_database WHERE (linkedForm = '$linkedForm' AND renewHoldingID = '$renewHoldingID') ORDER BY id ASC";
        ...
        if ($rowr['paymentStatus'] == 'Unpaid') {
            ...
            <div class="notify">
                <form method="post" enctype="multipart/form-data">
                    <p>হোল্ডিং ট্যাক্স বকেয়া পরিশোধ করতে <b style="font-size: 20px;"><?php echo banglaNumber($rowr['payableAmount']); ?></b> টাকা পেমেন্ট করুন।</p>
        ...
        <table class="responstable">
            ...
            <tr>
                <td>হোল্ডিং ফী</td>
                <td><?php echo banglaNumber($rowr['holdingFee']); ?> টাকা</td>
            </tr>
            <tr>
                <td>ডিস্কাউন্ট</td>
                <td><?php echo banglaNumber($rowr['feeDiscount']); ?> টাকা</td>
            </tr>
            <tr>
                <td>পরিশোধিত টাকা</td>
                <td><?php echo banglaNumber($rowr['payableAmount']); ?> টাকা</td>
            </tr>
            <tr>
    ...
    <div id="print-main-div-holding">
        <div class='print-header'>
            ...
            <div style='margin-left:25%;margin-bottom: 20px;'>
                <p style='font-size:36px;font-weight:bold;'>ইউনিয়ন পরিষদ<br/>
        ...
        <div class='print-header-bottom'>
            <p>স্মারক নংঃ ইউ/পরি/হো/ট্যা/পে/রি/<?php echo banglaNumber($rowr['renewHoldingID']); ?></p>
            <p>তারিখঃ <?php echo banglaNumber($date); ?> ইং</p>
        </div>

        <p style="text-align: center;margin-top: 150px;color: #1e2039;font-size: 36px;font-weight: bold;">হোল্ডিং ট্যাক্স পেমেন্ট রিসিট</p>

        <div style="width: 900px;margin: 100px auto;">
            <table class="responstable-print">
                <tbody>
                    <tr>
                        <td>নাগরিক কার্ড নাম্বার</td>
                    ...
                    <tr>
                        <td>পেমেন্ট স্ট্যাটাস</td>
                        <td><a style="display: inline-block;font-size: 18px;color: #23b14d;font-weight: bold;"><i class='fa fa-check'></i> পরিশোধিত</a></td>
                    </tr>
