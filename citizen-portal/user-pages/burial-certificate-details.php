...
if (!empty($_SESSION['linkedForm']) && !empty($_SESSION['certificateID'])) {
    ...
    echo "<script type='text/javascript'> document.location = 'citizen/burial-certificate'; </script>";
    die();
}
...
if($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (isset($_POST['payment-done'])) {
        ...
        $paymentUpdate = "UPDATE burial_certificate_apply SET paymentStatus='Paid' WHERE (linkedForm='$linkedForm' AND certificateID='$certificateID')";
...
<div class="content-body-main-div">
    ...
    <p class="page-direction"><i class="fa fa-link"></i> নাগরিক পোর্টাল / দাফন সনদ / বিস্তারিত /</p>

    <div class="admin-dashboard-content-div">

        <h2 style="font-family:'Bangla';color: #5e5e5e;border-bottom:1px solid #5e5e5e;">দাফন সনদ বিস্তারিতঃ</h2>

        <?php
        $sqlr = "SELECT * FROM burial_certificate_apply WHERE (linkedForm = '$linkedForm' AND certificateID = '$certificateID') ORDER BY id ASC";
        ...
        <table class="responstable">
            ...
            <tr>
                ...
                <td>
                    ...
                    /*
                    if ($rowr['paymentStatus'] == 'Unpaid') {
                        echo "<button onclick='LoaderShow()' type='submit' name='certificate-payment' class='edit-window' style='cursor: pointer; color: #ff3333; background: none; height: 0; border: 0; margin: 0; width: auto; font-weight: bold;'>পেমেন্ট করুন ({$payBdt} টাকা)</button>";
                    }
                    */
                    ?>
                </td>
    ...
    <div id="print-main-div">
        <div style="border: 3px solid #1e2039;padding: 10px;">
            <div class='print-header-top'>
                <p>স্মারক নংঃ ইউ/পরি/দা/স/<?php echo banglaNumber($certificateID); ?></p>
            ...
            <p style="text-align: center;margin-top: 80px;color: #1e2039;font-size: 52px;font-weight: bold;">দাফন সনদপত্র</p>
