...
<div class="header-main-container">
    <div class="header-container">
        <div class="header-section-left">
            ...
            <img src="assets/images/logo-site.png" alt="site logo" height="32">
            <a href="citizen/dashboard" style="text-decoration: none; color: #FFFFFF; font-size: 24px; font-family: 'Bangla';">ইউনিয়ন পরিষদ</a>
        </div>
            ...
            <div id="profile-idDropdown" class="profile-dropdown-content profile-width">
                <div class="profile-dropdown-content-div">
                    <div class="main-profile-menu">
                        ...
                        <div>
                            <a onclick="LoaderShow()" href="citizen/logout" style="color: #ff3333;" class="underline-hover"><i class="fa fa-sign-out"></i> Log Out</a>
                        </div>
                    </div>
                </div>
            </div>
