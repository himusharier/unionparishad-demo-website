...
if (!empty($_SESSION['linkedForm']) && !empty($_SESSION['certificateID'])) {
    ...
    echo "<script type='text/javascript'> document.location = 'citizen/unmarried-certificate'; </script>";
    die();
}
...
if($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (isset($_POST['payment-done'])) {
        ...
        $paymentUpdate = "UPDATE unmarried_certificate_apply SET paymentStatus='Paid' WHERE (linkedForm='$linkedForm' AND certificateID='$certificateID')";
        if (mysqli_query($db, $paymentUpdate)) {
            echo "<script type='text/javascript'> document.location = 'citizen/unmarried-certificate-details'; </script>";
        }
    }
...
<script>
    document.title = 'অবিবাহিত সনদ - ইউনিয়ন পরিষদ';
</script>
...
<div class="content-body-main-div">
    ...
    <p class="page-direction"><i class="fa fa-link"></i> নাগরিক পোর্টাল / অবিবাহিত সনদ / বিস্তারিত /</p>

    <div class="admin-dashboard-content-div">

        <h2 style="font-family:'Bangla';color: #5e5e5e;border-bottom:1px solid #5e5e5e;">অবিবাহিত সনদ বিস্তারিতঃ</h2>
        <?php
        $sqlr = "SELECT * FROM unmarried_certificate_apply WHERE (linkedForm = '$linkedForm' AND certificateID = '$certificateID') ORDER BY id ASC";
    ...
    <div id="print-main-div">
        <div style="border: 3px solid #1e2039;padding: 10px;">
            <div class='print-header-top'>
                <p>স্মারক নংঃ ইউ/পরি/অবি/স/<?php echo banglaNumber($certificateID); ?></p>
            ...
            <p style="text-align: center;margin-top: 80px;color: #1e2039;font-size: 52px;font-weight: bold;">অবিবাহিত সনদপত্র</p>
            <p style="font-size: 24px;margin-top: 50px;padding: 0 80px;">
                ...
                <br/><br/>
                তিনি ইউনিয়ন পরিষদের <b><?php echo banglaNumber($rowr['wardNo']) ?></b> নং ওয়ার্ডের স্থায়ী বাসিন্দা। আমি তাকে চিনি এবং জানি। তিনি জন্মসূত্রে বাংলাদেশের নাগরিক। আমার জানামতে সে কোনো বিবাহ বন্ধনে আবদ্ধ হয় নাই। তার নৈতিক চরিত্র ভালো।
                <br/><br/><br/>
