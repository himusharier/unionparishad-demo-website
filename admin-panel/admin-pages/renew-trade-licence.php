...
<div class="content-body-main-div">
    ...
    <p class="page-direction"><i class="fa fa-link"></i> নাগরিক সেবা / ট্রেড লাইসেন্স নবায়ন /</p>

    <div class="admin-dashboard-content-div">
        <h2 style="font-family:'Bangla';color: #5e5e5e;border-bottom:1px solid #5e5e5e;">ট্রেড লাইসেন্স নবায়ন সেবাঃ</h2>
    ...
    $(document).ready(function () {
        $("#search-btn").click(function () {
            ...
            if(citizenCardNo == "") {
                ...
                $.ajax({
                    url: 'script/renew-trade-licence-script-step1',
                    type: 'POST',
                    data: {
