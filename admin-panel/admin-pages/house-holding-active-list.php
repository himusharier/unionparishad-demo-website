...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if(isset($_POST['perPageLimit'])){
        ...
        if (clean_inputs($_POST['perPageLimit']) == "100") {
            ...
            echo "<script type='text/javascript'> document.location = 'admin/active-house-holding'; </script>";
        }
...
<div class="content-body-main-div">
    ...
    <p class="page-direction"><i class="fa fa-link"></i> বসত বাড়ী হোল্ডিং / সক্রিয় কার্ড তথ্য তালিকা</p>

    <div class="dashboard-table-container">
        <p class="dashboard-table-container-heading">বসত বাড়ী হোল্ডিংঃ সক্রিয় কার্ড তথ্য তালিকা</p>
        <table class="responstable">
            ...
            $sqlr = "SELECT * FROM house_holding_database WHERE cardStatus='সক্রিয়' ORDER BY id ASC LIMIT {$start_from}, ".$results_per_page;
    ...
    <div class="bottom-pagination">
        <?php
        $sqlpn = "SELECT COUNT(id) AS total FROM house_holding_database WHERE cardStatus='সক্রিয়'";
        ...
        for ($i=1; $i<=$total_pages; $i++) {
            ...
            echo "' href='admin/active-house-holding?page={$i}'>{$i}</a>";
