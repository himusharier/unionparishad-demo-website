...
<script>
    document.title = 'নাগরিক ভাতা প্রেরণ - ইউনিয়ন পরিষদ';
</script>
...
<div class="content-body-main-div">
    ...
    <p class="page-direction"><i class="fa fa-link"></i> নাগরিক সেবা / নাগরিক ভাতা প্রেরণ /</p>

    <div class="admin-dashboard-content-div">
        <h2 style="font-family:'Bangla';color: #5e5e5e;border-bottom:1px solid #5e5e5e;">নাগরিক ভাতা প্রেরণ সেবাঃ</h2>
    ...
    $(document).ready(function () {
        $("#search-btn").click(function () {
            ...
            if(citizenCardNo == "") {
                ...
                $.ajax({
                    url: 'script/allowance-given-script-step1',
                    type: 'POST',
                    data: {
