...
<div class="content-body-main-div">
    ...
    <p class="page-direction"><i class="fa fa-link"></i> বসত বাড়ী হোল্ডিং / তথ্য তালিকা</p>
    ...
    <div class="dashboard-table-container">
        ...
        <table class="responstable">
            ...
            $sqlr = "SELECT * FROM house_holding_database ORDER BY id ASC LIMIT {$start_from}, ".$results_per_page;
    ...
    <div class="bottom-pagination">
        <?php
        $sqlpn = "SELECT COUNT(id) AS total FROM house_holding_database";
        ...
        for ($i=1; $i<=$total_pages; $i++) {
            ...
            echo "' href='admin/list-house-holding?page={$i}'>{$i}</a>";
