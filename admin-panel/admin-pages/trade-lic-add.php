...
<div class="content-body-main-div">
    ...
    <p class="page-direction"><i class="fa fa-link"></i> ট্রেড লাইসেন্স / নতুন তথ্য যোগ করুন /</p>
                ...
                <table>
                    ...
                    <tr>
                        <td>
                            ...
                            <input type="text" name="idNumber" id="idNumber" autocomplete="off" value="">
                        </td>
                        <td>
                            <label>পিন নাম্বারঃ</label>
                            <input type="text" name="pinNumber" id="pinNumber" autocomplete="off" value="">
                        </td>
                        <td>
                ...
                <tbody>
                    <tr>
                        <td>
                            ...
                            <input type="checkbox" name="haveLicense" id="haveLicense" value="checked">
                        </td>
                        <td>
                            <label>ট্রেড লাইসেন্স নংঃ</label>
                            <input type="text" name="tradeLicense" id="tradeLicense" autocomplete="off" value="">
                        </td>
                        <td>
                            <label>ক্রমিক নংঃ</label>
                            <input type="text" name="serialNo" autocomplete="off" value="">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label>শেষ নবায়নের তারিখঃ (মাস/দিন/সাল)</label>
                            <input type="date" name="lastRenew" id="lastRenew" autocomplete="off" value="">
                        </td>
                        <td>
                            <label>ট্রেড লাইসেন্স পরিচিত নংঃ</label>
                            <input type="text" name="tradeLicIntroNo" autocomplete="off" value="">
                        </td>
                        <td>
                            <label>ব্যবসা প্রতিষ্ঠানের নামঃ</label>
                            <input type="text" name="businessName" autocomplete="off" value="">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label>প্রোপাইটরের নামঃ</label>
                            <input type="text" name="proprietorName" autocomplete="off" value="">
                        </td>
                        <td>
                            <label>পিতার নামঃ</label>
                            <input type="text" name="fatherName" autocomplete="off" value="">
                        </td>
                        <td>
                            <label>মাতার নামঃ</label>
                            <input type="text" name="motherName" autocomplete="off" value="">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            ...
                            <input type="text" name="nidNo" autocomplete="off" value="">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            ...
                            <input type="text" name="tradeLicFee" autocomplete="off" value="">
                        </td>
                        <td>
                            <label>সাইনবোর্ড করঃ (বার্ষিক)</label>
                            <input type="text" name="signboardTax" autocomplete="off" value="">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label>ভ্যাটঃ</label>
                            <input type="text" name="totalTax" autocomplete="off" value="">
                        </td>
                        <td>
                            <label>সর্বমোট টাকাঃ</label>
                            <input type="text" name="totalAmount" autocomplete="off" value="">
                        </td>
                        <td></td>
                    </tr>
                </tbody>
                ...
                <tbody>
                    <tr>
                        <td>
                            ...
                            <input type="text" name="wardNo" autocomplete="off" value="">
                        </td>
                        <td>
                            <label>গ্রামঃ</label>
                            <input type="text" name="village" autocomplete="off" value="">
                        </td>
                        <td>
                            <label>পোস্টাল কোড/ জিপ কোডঃ</label>
                            <input type="text" name="zip" autocomplete="off" value="">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label>ডাকঘরঃ</label>
                            <input type="text" name="post" autocomplete="off" value="">
                        </td>
                        <td></td>
                        <td></td>
                    </tr>
    ...
    $(document).ready(function () {
        $("#submit-btn").click(function () {
            ...
            if(haveLicense == "" || tradeLicense == "" || lastRenew == "") {
                ...
                $.ajax({
                    url: 'script/trade-lic-form-data-insert',
                    type: 'POST',
